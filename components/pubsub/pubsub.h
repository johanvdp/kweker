...
typedef enum
{
    PUBSUB_TYPE_UNKNOWN = 0,
    PUBSUB_TYPE_INT = 1,
    PUBSUB_TYPE_DOUBLE = 2,
    PUBSUB_TYPE_BOOLEAN = 3
} pubsub_type_t;
...
extern pubsub_topic_t pubsub_register_topic(const char *topic_name, const pubsub_type_t type);
