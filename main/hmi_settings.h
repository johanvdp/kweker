...
void hmi_settings_set_current_time_callback(hmi_settings_time_callback_t callback);

void hmi_settings_set_begin_of_day(time_t timestamp);
void hmi_settings_set_begin_of_day_callback(hmi_settings_time_callback_t callback);

void hmi_settings_set_begin_of_night(time_t timestamp);
void hmi_settings_set_begin_of_night_callback(hmi_settings_time_callback_t callback);
